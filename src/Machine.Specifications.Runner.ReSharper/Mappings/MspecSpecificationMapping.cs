...
public class MspecSpecificationMapping(MspecServiceProvider services)
    : MspecElementMapping<MspecSpecificationTestElement, MspecSpecificationRemoteTask>(services)
{
